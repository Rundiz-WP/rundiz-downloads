...
if (!class_exists('\\RundizDownloads\\App\\Libraries\\RundizSettings')) {
    ...
    class RundizSettings
    {
         ...
         * 
         * @since 2026-07-28
         * @param \RundizDownloads\App\Libraries\Loader $Loader The `Loader` class.
        ...
        {
            $kses_data_file = dirname(RUNDIZDOWNLOADS_FILE) . '/App/config/kses_data.php';
        ...
        private function renderFormMedia($field_key, array $fields, array $options_values = [])
        {
            ...
            $output .= '<input type="button" class="button-secondary upload-media-button" value="' . esc_attr__('Upload', 'rundiz-downloads') . '" data-input-target="' . esc_attr($field_name) . '">' . "\n";
            $output .= '<input type="button" class="button-secondary remove-media-button" value="' . esc_attr__('Remove', 'rundiz-downloads') . '" data-input-target="' . esc_attr($field_name) . '">' . "\n";
