...
if (!class_exists('\\RundizDownloads\\App\\Libraries\\StylesAndScripts')) {
    ...
    class StylesAndScripts
    {
        ...
        public function registerAdminStylesAndScripts()
        {
            ...
            // manual update
            wp_register_script('rundiz-downloads-settings-manual-update-js', plugin_dir_url(RUNDIZDOWNLOADS_FILE) . 'assets/js/Admin/rd-settings-manual-update.js', ['jquery'], RUNDIZDOWNLOADS_VERSION, true);
