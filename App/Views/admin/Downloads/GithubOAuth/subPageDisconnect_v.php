<div class="wrap rundiz-downloads-page-githuboauth rundiz-downloads-page-githuboauth-subpage-disconnect">
    ...
    <form method="post">
        ...
        <button class="button button-primary"><i class="fas fa-sign-out-alt"></i> <?php esc_html_e('Confirm disconnect', 'rundiz-downloads'); ?></button>
    </form>
    <?php } else { ?>
    <p><?php
    /* translators: %1$s: Open link, %2$s: Close link. */
    printf(esc_html__('You has beed disconnected from GitHub. %1$sGo back%2$s to connect page.', 'rundiz-downloads'), '<a href="' . esc_url($thisPageUrl) . '">', '</a>');
    ?></p>
    <?php }// endif; ?>
</div><!--.wrap-->