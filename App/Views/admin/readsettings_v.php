...
/*<div class="wrap">
    ...
    <ol>
        ...
        <li><?php printf(__('Access this variable as global <code>%s</code>. This variable will be change, up to config in AppTrait.', 'rundiz-downloads'), 'global $rd_downloads_options;'); ?></li>
